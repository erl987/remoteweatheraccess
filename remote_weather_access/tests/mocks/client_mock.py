...
def main():
    ...
    """
    # provide a first time close to real time, rounded to full 10-minutes
    ...
    while True:
        ...
        try:
            ...
            weather_data_file.write(curr_temp_dir_path, data, station_metadata)

            # copy the data file to the weather server receiver directory for consumption
            archive_file_name = temp_dir_path + os.sep + curr_time_string + "_" + station_id + "." + archive_file_type
