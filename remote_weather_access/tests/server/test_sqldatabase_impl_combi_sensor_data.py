...
from common.datastructures import WeatherStationDataset, CombiSensorData
from server._sqldatabase_impl import _CombiSensorDataTable, _CombiSensorDefinitionTable
...
class CombiSensorDataset(object):
    """Test object builder"""
    def __init__(self):
