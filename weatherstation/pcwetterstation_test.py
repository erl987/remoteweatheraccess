...
class Test_pcwetterstation(unittest.TestCase):
    ...
    def test_read(self):
        ...
        data, rain_calib_factor, rain_counter_base, station_name, station_height, station_type = pcwetterstation.read( data_folder, test_file_name, te923ToCSVreader.sensor_list )
