...
def transferto(ftp_server, user_name, passwd, data_folder, data_file_list):
    ...
    Raises:
    The function will raise errors in cause network failures. See ftp-lib documentation for details depending on the type of error.
    """
