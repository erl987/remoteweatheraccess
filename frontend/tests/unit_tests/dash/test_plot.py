...
from frontend.django_frontend.weatherpage.dash_weatherpage.plot import get_scalings, determine_plot_axis_setup
...
def test_determine_plot_axis_setup():
    ...
    rel_secondary_axis_offset = 0.1

    left_main_axis_pos, right_main_axis_pos, min_max_limits, num_ticks = \
        determine_plot_axis_setup(stations, data, sensors, rel_secondary_axis_offset)
    assert left_main_axis_pos == rel_secondary_axis_offset
    assert right_main_axis_pos == 1 - rel_secondary_axis_offset
...
def test_determinate_plot_axis_setup_when_empty():
    assert determine_plot_axis_setup([], {}, [], 0) == (float('inf'), float('inf'), None, 0)
