...
from .utils import client_without_permissions, client_with_push_user_permissions, a_dataset, another_dataset, \
...
def test_create_dataset(client_with_push_user_permissions, a_dataset):
    ...
    location_result = client_with_push_user_permissions.get(result.headers['Location'])
...
@pytest.mark.usefixtures('client_with_push_user_permissions', 'a_dataset', 'another_dataset')
def test_delete_dataset(client_with_push_user_permissions, a_dataset, another_dataset):
    ...
    delete_result = client_with_push_user_permissions.delete('/api/v1/data/{}'.format(dataset_id))
...
def test_update_dataset(client_with_push_user_permissions, a_dataset, an_updated_dataset):
    ...
    update_result = client_with_push_user_permissions.put('/api/v1/data/{}'.format(id), json=an_updated_dataset)
    ...
    location_result = client_with_push_user_permissions.get(update_result.headers['Location'])
...
def test_update_dataset_with_time_point_mismatch(client_with_push_user_permissions, a_dataset, another_dataset):
    ...
    assert create_result.status_code == HTTPStatus.CREATED
    id = create_result.get_json()['id']
    update_result = client_with_push_user_permissions.put('/api/v1/data/{}'.format(id), json=another_dataset)
    assert 'error' in update_result.get_json()
...
def test_update_dataset_with_invalid_body(client_with_push_user_permissions, a_dataset):
    ...
    del invalid_dataset['humidity']
    invalid_dataset['humid'] = 12
    result = client_with_push_user_permissions.put('/api/v1/data/1', json=invalid_dataset)
    assert 'error' in result.get_json()
    assert result.status_code == HTTPStatus.BAD_REQUEST
...
@pytest.mark.usefixtures('client_with_push_user_permissions', 'a_dataset')
def test_get_one_weather_dataset(client_with_push_user_permissions, a_dataset):
    create_result = client_with_push_user_permissions.post('/api/v1/data', json=a_dataset)
    assert create_result.status_code == HTTPStatus.CREATED
    id = create_result.get_json()['id']
